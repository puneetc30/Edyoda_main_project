                    ...
                    while True:
                        ...
                        if user_choice == 1:
                            ...
                            for k,v in food_info_list.items():
                                print(counter,"|","Food Name:",v.food_name,"|","Food Price:",v.food_price,"|","Food Quantity:",v.food_qty,"|","Food Discount:",v.discount)
                                counter = counter + 1
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("**********************************")
        print("1.Press 1 to create Admin Account \n2.Press 2 to create User Account\n3.Press 3 for Admin Login\n4.Press 4 for User Login\n5.Press 0 to exit")
        print("**********************************")
